...
if ( class_exists( 'Sage_Ai_Writer' ) ) {
	...
	class Sage_Ai_Writer {
		...
		function ai_content_writer_edit_include_files() {
			...
			require_once WP_SAGE_AI_DIR . '/inc/public/class-sage-ai-public-chatbot.php';
			require_once WP_SAGE_AI_DIR . '/inc/admin/embeddings.php';
			...
			// if ( is_admin() ) {
				...
				require_once WP_SAGE_AI_DIR . '/inc/fetch/callWhisper.php';
				require_once WP_SAGE_AI_DIR . '/inc/fetch/callEmbeddings.php';
				require_once WP_SAGE_AI_DIR . '/inc/admin/bulk-pages-generator.php';
				require_once WP_SAGE_AI_DIR . '/inc/admin/chatbot.php';
				require_once WP_SAGE_AI_DIR . '/inc/admin/upload-to-media-library.php';
